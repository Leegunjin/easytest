...
<body>
	...
	<div id="boards">
		<div title="int">
			...
			<p>int</p>
			<div>
				<input type="text" id="name1" size="30" maxlength="5"
					placeholder="입력하세요">
			</div>
		...
		<div title="double">
			...
			<p>Double</p>
			<div>
				<input type="text" id="name2" size="30" maxlength="5"
					placeholder="입력하세요">
			</div>
		...
		<div title="string">
			...
			<p>String</p>
			<div>
				<input type="text" id="name3" size="30" maxlength="5"
					placeholder="입력하세요">
			</div>
		...
		<div title="boolean">
			...
			<p>Boolean</p>
			<div>
				<input type="text" id="name4" size="15" maxlength="5"
					placeholder="입력하세요">
			</div>
		</div>
			</div>
