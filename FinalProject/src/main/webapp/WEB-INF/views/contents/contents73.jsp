	...
	$(function() {
		...
		function goToNextSlide() {
			...
			if (currentSlide >= slideCount - 1) {
				location.href = "clearChapter?c_num=739";
			}
			var windowWidth = $(window).width();
			currentSlide++;
		...
		$('#printBtn').on('click', function() {
			var str = '  <img alt="" src="../resources/img/cal.png">';
			$('#resultDiv').html(str);
		});
	});
</script>
		...
		<ul class="slide-container">
			<li class="slide" data-tag="day">
				<div class="sized-container">
					...
					<div class="example">
						<h2>Q) 월요일 = 1; 화요일 = 2; 수요일 = 3; 목요일 = 4; 금요일 = 5; 토요일 = ?</h2>
			...
			<li class="slide" data-tag="class">
				<div class="sized-container">
					...
					<div class="example">
						<h2>Q) 1교시 = 1; 2교시 = 2; 3교시 = 3;...6교시 = ?</h2>
						<div class="buttonDiv" answer="6">
							<input type="button" value="2" answer="2" width="100"
								class="shortCodeEditor"> <input type="button" value="4"
								answer="4" width="100" class="shortCodeEditor"> <input
								type="button" value="6" answer="6" width="100"
								class="shortCodeEditor"> <input type="button" value="8"
								answer="8" width="100" class="shortCodeEditor">
						</div>
			...
			<li class="slide" data-tag="day-array">
				<div class="sized-container">
					<div class="concept">
						<h1>월요일에서 금요일까지를 나타내는 String 배열을 골라주세요.</h1>
					</div>
					<div class="example">
						<h2>Q) String 요일 배열을 선언, 생성하는 코드를 고르세요.</h2>
						<div class="buttonDiv"
							answer="String[ ] 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;토요일&ldquo;};">
							<input type="button"
								value="String[ ] 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;토요일&ldquo;};"
								answer="String[ ] 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;토요일&ldquo;};"
								width="500" class="shortCodeEditor"><br> <input
								type="button"
								value="String[ ] 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;토요일&ldquo;}"
								answer="String[ ] 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;토요일&ldquo;}"
								width="500" class="shortCodeEditor"><br> <input
								...
								value="[ ]String 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;토요일&ldquo;}"
								answer="[ ]String 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;토요일&ldquo;}"
								width="500" class="shortCodeEditor">
						</div>
			...
			<li class="slide" data-tag="class-array">
				<div class="sized-container">
					<div class="concept">
						<h1>1교시에서 6교시까지 배열을 표현해 봅시다.</h1>
					</div>


					<div class="example">
						<h2>Q) int 수업 배열을 선언, 생성하는 코드를 고르세요.</h2>
						<div class="buttonDiv" answer="int[ ] 수업 = {1, 2, 3, 4, 5, 6};">
							<input type="button" value="int[ ] 수업 = {1, 2, 3, 4, 5, 6}"
								answer="int[ ] 수업 = {1, 2, 3, 4, 5, 6}" class="shortCodeEditor">
							<input type="button" value="[ ]int 수업 = {1, 2, 3, 4, 5, 6}"
								answer="[ ]int 수업 = {1, 2, 3, 4, 5, 6}" class="shortCodeEditor">
								<input type="button" value="int[ ] 수업 = {1, 2, 3, 4, 5, 6};"
								answer="int[ ] 수업 = {1, 2, 3, 4, 5, 6};" class="shortCodeEditor">
			...
			<li class="slide" data-tag="day-for">
				<div class="sized-container">
					<div class="concept">
						<h3>
							String[ ] 요일 =
							{&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;,토요일&ldquo;};<br>
						</h3>
					</div>
					<div class="example">
						<h2>[요일] 배열에 대한 for문을 선택해 주세요.</h2>
						<div class="buttonDiv" answer="for (int i = 1; i &lt;= 요일.length; i++) {  }">
							 <input type="button"
								value="for (int i = 1; i &lt; 요일.length; ++i) {     }"
								answer="for (int i = 1; i &lt; 요일.length; ++i) {     }"
								class="shortCodeEditor"> 
								<input type="button" value="for (int i = 1; i &lt;= 요일.length; i--) {     }" answer="for (int i = 1; i &lt;= 요일.length; i--) {     }"
								class="shortCodeEditor"> 
								<input type="button" value="for (int i = 1; i &lt;= 요일.length; i++) {     }"
								answer="for (int i = 1; i &lt;= 요일.length; i++) {  }" class="shortCodeEditor">
								<input type="button" value="for (int i = 1; i &lt;= 요일.length; --i) {     }"
								answer="for (int i = 1; i &lt;= 요일.length; --i) {     }" class="shortCodeEditor">
						</div>
					</div>
			...
			<li class="slide" data-tag="class-for">
				<div class="sized-container">
					...
					<div class="example">
						<h2>[int] 배열에 대한 for문을 선택해 주세요.</h2>
						<div class="buttonDiv"
							answer="for (int j = 1; j &lt;= 교시.length; j++) {  	}">
							<input type="button"
								value="for (int j = 1; j &lt;= 교시.length; ++j) {  	}"
								answer="for (int j = 1; j &lt;= 교시.length; ++j) {  	}"
								class="shortCodeEditor"> <input type="button"
								value="for (int j = 1; j &lt;= 교시.length; j--) {  	}"
								answer="for (int j = 1; j &lt;= 교시.length; j--) {  	}"
								class="shortCodeEditor"> <input type="button"
								value="for (int j = 1; j &lt;= 교시.length; --j) {  	}"
			...
			<li class="slide" data-tag="table1">
				<div class="sized-container">
                   ...
                   <div class="str">String[ ] 요일 = {&ldquo;월요일&ldquo;,&ldquo;화요일&ldquo;,&ldquo;수요일&ldquo;,&ldquo;목요일&ldquo;,&ldquo;금요일&ldquo;};
	             <br> int[ ] 교시 = {1, 2, 3, 4, 5, 6};
	               <br> for (int j = 1; j &lt;= 교시.length; j++) {  	
	               <br> for (int i = 1; i &lt;= 요일.length; i++) {  
