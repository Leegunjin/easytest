   ...
   $(function() {
     ...
     // 다음 슬라이드로 이동
      ...
      if(currentSlide >= slideCount - 1) {
    	  location.href = "clearChapter?c_num=525";
         return
         }; 
		...
		<li class="slide" data-tag="Step7">
			<div class="sized-container">
				...
				<div class="question_div7">
					<h2 class="radio_h2">
					for ( int num = 10 ; num &gt; 0 ; num-- ) { <br><br>
						&emsp; &emsp;
						if ( num % 2 == 1 ) {<br>
							&emsp; &emsp;&emsp; &emsp;
							System.out.print( num + " " );<br><br>
		...
		<li class="slide" data-tag="Step9">
			<div class="sized-container">
				...
				<div class="question_div9">
					<h2 class="radio_h2">
					int multiply = 1;
					for ( int num = 5 ; num &gt;= 0 ; num-- ) { <br><br>
						&emsp; &emsp;
						if ( num % 2 == 1 ) {<br>
							&emsp; &emsp;&emsp; &emsp;
							multiply = multiply * num ;<br>
							&emsp; &emsp;&emsp; &emsp;
							System.out.print( "multiply : " + multiply );<br><br>
						&emsp; &emsp;
						}<br>
					}
					</h2>
